...
for individual_link in Paston_main:
    ...
    for new_variable in all_divs:
        ...
        try:
            ...
            a_string = a_person.text
            q = re.compile("\d")
            a_date = q.findall(a_string)
        except:
            a_date = "No recipient information"
        ...
        new_dictionary={"Writer":a_writer,"Recipient":a_name,"Date":a_date,"Document ID":letter_id_counter,"Document URL":individual_link,"Content":letter_content}
