...
for individual_link in Paston_main:
    ...
    for new_variable in all_divs:
        ...
        #,"Document ID:":letter_id_counter,"Document URL":individual_link,"Content":letter_content}
        Paston_dictionary_list.append(new_dictionary)
        letter_id_counter = letter_id_counter + 1
json.dump(Paston_dictionary_list,open("Paston_Letters_gephi_attempt_1.json","w"),indent=4)
